...
class JwtUtilsTest {
    ...
    void shouldGenerateJwtAndVerifyFields() {
        ...
        LocalDateTime currentLocalDateTime = LocalDateTime.ofInstant(Instant.ofEpochMilli(System.currentTimeMillis()), ZoneId.of(DateComparator.UTC_ZONE_ID));
        ...
        LocalDateTime generateLocalDateTimeExp = DateComparator.convertToLocalDateTimeViaInstant(Long.parseLong(String.valueOf(claims.get("exp"))) * 1000);
